...
const SinglePortfolio = ({ portfolio }: { portfolio: Portfolio }) => {
  const { title, image, paragraph, author, tags, publishDate, id } = portfolio;
  return (
    <>
      <div
      ...
      >
        <Link
          href={{ pathname: `/portfolio-details/${id.toString()}`, query: id.toString() }}
        ...
        <div className="p-6 sm:p-8 md:px-6 md:py-8 lg:p-8 xl:px-5 xl:py-8 2xl:p-8">
          <h3>
            <Link
              href={`/portfolio-details/${id.toString()}`}
